...
# View full guide
file.show("RANDOM_FOREST_AGRICULTURE.md")
...
1. **Using ANY data?** Read [RANDOM_FOREST_ANY_DATA.md](RANDOM_FOREST_ANY_DATA.md)
2. **Agriculture focus?** Read [RANDOM_FOREST_AGRICULTURE.md](RANDOM_FOREST_AGRICULTURE.md)
3. Run example demos:
